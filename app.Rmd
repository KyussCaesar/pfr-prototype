...
```{r}
renderValueBox({
  incomes = vals$records[vals$records[,"type"] == "income",c("amount", "freq")]
  print(incomes)
...
```{r}
renderValueBox({
  incomes = vals$records[vals$records[,"type"] == "expense",c("amount", "freq")]
  print(incomes)
...
```{r}
renderValueBox({
  incomes = vals$records[,c("amount", "freq", "type")]
